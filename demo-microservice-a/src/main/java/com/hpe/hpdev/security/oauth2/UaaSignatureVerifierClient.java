package com.hpe.hpdev.security.oauth2;

import com.hpe.hpdev.config.oauth2.OAuth2Properties;
...
public class UaaSignatureVerifierClient implements OAuth2SignatureVerifierClient {
    ...
    public UaaSignatureVerifierClient(DiscoveryClient discoveryClient, @Qualifier("vanillaRestTemplate") RestTemplate restTemplate,
    ...
    public SignatureVerifier getSignatureVerifier() throws Exception {
        try {
            ...
            String url = getPublicKeyEndpoint();

            System.out.println("getPublicKeyEndpoint() = " + url);

//            url = "http://127.0.0.1/oauth/token_key";
